...
def turtle2():
    ...
    i_am_going_here = rg.Point(-250, 25)
...
def turtle4():
    turt4 = rg.SimpleTurtle('turtle')
    turt4.pen = rg.Pen('red', 3)
    turt4.right(45)
    turt4.draw_square(50)

def turtle5():
    turt5 = rg.SimpleTurtle('square')
    turt5.pen = rg.Pen('blue',10)
    turt5.left(45)
    turt5.draw_circle(35)
